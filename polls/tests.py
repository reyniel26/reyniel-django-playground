...
# shortcut function to create question
...
# Important Note!!!
# After completing the full tutorial in Writing Django
# Try to add or customize Test on your own
# You can write it below or update the existing test above